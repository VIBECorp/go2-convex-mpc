"""
Demo 06: Unitree A2 standing body posture control (all four feet in stance)

The A2 (~40 kg) keeps all four feet on the ground (StandGait) while the MPC tracks
time-varying body posture commands:
    ...
    9-12 s  : height squat     (0.34 m - 0.46 m)
...
# The A2 is ~2.7x heavier than the Go2, so velocity damping weights are higher
...
fig.suptitle("A2 Standing Body Posture Tracking")
fig.tight_layout()
